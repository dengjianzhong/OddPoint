...
public class QuickIndexBarView extends View {
    ...
    /**
     * The interface On letter change listen.
     */
//自定义一个字母改变的监听
    ...
    /**
     * Instantiates a new Quick index bar view.
     *
     * @param context the context
     */
    public QuickIndexBarView(Context context) {
        this(context, null);
    }
     ...
     */
    public QuickIndexBarView(Context context, AttributeSet attrs, int defStyle) {
